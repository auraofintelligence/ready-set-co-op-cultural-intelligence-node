...
const pages = {
    ...
    body: `
      <section class="section section-light" id="starting-point">
        <div class="wrap intro-grid reveal">
          <div>
            <h2>A practical local starting point</h2>
      ...
      <section class="section section-light">
        <div class="wrap reveal">
          ...
          <ol class="process-rail">
            ...
            <li><span>06</span><strong>Test in the real world</strong><small>Evidence shapes what happens next.</small></li>
  ...
  'node.html': {
    ...
    body: `
      <section class="section section-light"><div class="wrap intro-grid reveal">
        <div><h2>What the reference means</h2><p class="lead">GB200 NVL72 is a rack-scale computing system. Here it acts as a scale reference: a major step beyond a personal workstation while remaining locally legible beside hyperscale infrastructure.</p></div>
  ...
  'uses.html': {
    ...
    body: `
      ...
      <section class="section section-ink" id="workloads"><div class="wrap reveal"><h2>Six workload families</h2><div class="use-grid">
        ...
        <article><span class="use-number">03</span><h3>Island digital twin</h3><p>Layered views of environment, infrastructure, movement, hazards and community observations with provenance and uncertainty visible.</p><small>Starts with a clear question, not a total island model.</small></article>
      ...
      <section class="section section-lime"><div class="wrap reveal"><h2>A workload earns its place through evidence</h2><div class="evidence-loop"><div><strong>Purpose</strong><span>Who finds this useful?</span></div><div><strong>Boundary</strong><span>What is out of scope?</span></div><div><strong>Live pilot</strong><span>What is the strongest useful first version?</span></div><div><strong>Observation</strong><span>What actually happened?</span></div><div><strong>Choice</strong><span>Stop, adjust, repeat or expand?</span></div></div></div></section>
  ...
  'digital-twin.html': {
    ...
    body: `
      ...
      <section class="section section-blue"><div class="wrap reveal"><h2>A focused first twin</h2><div class="three-grid"><article class="solid-card"><h3>One defining question</h3><p>For example: how do heat, power demand and service priorities interact around one possible node?</p></article><article class="solid-card"><h3>Purpose-fit sources</h3><p>Each source arrives with date, ownership, licence, spatial limits and uncertainty.</p></article><article class="solid-card"><h3>A reviewable result</h3><p>People compare the model with lived knowledge, correct it and decide whether another layer is worthwhile.</p></article></div></div></section>
  ...
  'sitemap.html': {
    ...
    body: `
      <section class="section section-light" id="all-pages"><div class="wrap reveal"><h2>Website pages</h2><div class="sitemap-grid">
        ...
        ${siteEntry('dunwich.html', 'Dunwich place study', 'Local context, open questions and the clearly bounded Ballow Road reference.')}
        ...
        ${siteEntry('digital-twin.html', 'Island digital twin', 'Source-labelled layers, uncertainty and a focused first model.')}
